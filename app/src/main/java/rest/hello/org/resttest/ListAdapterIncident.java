...
public class ListAdapterIncident extends ArrayAdapter<String> {
    String[] textIM, textTitle, textStatus, textCrit, textDate;
    //Integer[] image_id;
    Context context;

    public ListAdapterIncident(Activity context, String[] textIM, String[] textStatus, String[] textTitle, String[] textCrit, String[] textDate) {
        super(context, R.layout.list_row_incident, textIM);
        this.textIM = textIM;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View single_row = inflater.inflate(R.layout.list_row_incident, null,
                true);
