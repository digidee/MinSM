 ...
 */
public class IncidentResolve extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.incident_resolve);

        Intent intent = getIntent();
        im = intent.getStringExtra("im");

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle(getString(R.string.incident_resolve_title) + " " + im);
        ...
        resolveText = (EditText) findViewById(R.id.resolve_text);
    ...
    private class HttpRequestTask extends AsyncTask<Void, Void, Object_Incident> {
        ...
        protected void onPostExecute(Object_Incident incident) {
            ...
            Snackbar snack = Snackbar.make(getWindow().findViewById(R.id.view_incident_resolve_id),incident.getMessages().toString(), Snackbar.LENGTH_LONG);
            View snackView = snack.getView();
            TextView tv = (TextView) snackView.findViewById(android.support.design.R.id.snackbar_text);
            tv.setTextAlignment(snackView.TEXT_ALIGNMENT_CENTER);
            snack.show();
